...
export const preloaderIcon = `<svg version="1.1" id="loader-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
const Button = ({
  ...
  >
    {loading && (
      <LoaderContainer className="flex justify-center items-center no-pointer-events">
